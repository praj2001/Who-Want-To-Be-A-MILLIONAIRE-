...
Begin VB.Form Form8 
   ...
   Begin VB.Label lblquestion 
      BackStyle       =   0  'Transparent
      Caption         =   "Who won the Rookie of the Year Award in 2007-2008                                                             Season "
      BeginProperty Font 
         Name            =   "Myriad Hebrew"
         Size            =   21.75
         Charset         =   0
...
av = 1
MsgBox cmda.Caption + "=15%" + "," + cmdb.Caption + "=10%" + "," + cmdc.Caption + "=13%" + "," + cmdd.Caption + "=62" + ",", (vbOKOnly), "Ask a Friend"
cmav.Visible = False
End Sub
...
aaf = 1
MsgBox "Your friend says that he is not sure but he thinks that the answer is" + cmdd.Caption, (vbOKOnly), "Ask a Friend"
...
choice = MsgBox("Are Your Sure That" + "" + cmdd.Caption + "Is The Correct Answer?", vbYesNo, "Correct")
...
cmdc.Visible = False
cmdd.Visible = False
MsgBox "Congratualtion, You Are Correct! You Won $10,000", (vbOKOnly), ("Correct")
Form9.Visible = True
Form8.Visible = False
moneywon = moneywon + 9000
Timer6.Enabled = False
End If
End Sub
Private Sub cmdc_Click()
Dim choice3 As String
choice3 = MsgBox("Are Your Sure That" + cmdc.Caption + "" + "" + "Is The Correct Answer?", vbYesNo, "Correct")
