...
Begin VB.Form Form12 
   ...
   Begin VB.Label lblquestion 
      BackStyle       =   0  'Transparent
      Caption         =   "Which Player Got The Most Assist in 2000-2001                                                           Season "
      BeginProperty Font 
         Name            =   "Myriad Hebrew"
         Size            =   21.75
         Charset         =   0
...
av = 1
MsgBox cmda.Caption + "=95%" + "," + cmdb.Caption + "=2%" + "," + cmdc.Caption + "=1%" + "," + cmdd.Caption + "=2%" + ",", (vbOKOnly), "Ask a Friend"
cmav.Visible = False
End Sub
...
cmdc.Visible = False
cmdd.Visible = False
MsgBox "Congratualtion, You Are Correct! You Won 1 Million Dollars", (vbOKOnly), ("Millionaire")
Winning.Visible = True
Form12.Visible = False
moneywon = moneywon + 900000
