...
Begin VB.Form Form6 
   ...
   Begin VB.CommandButton cmda 
      BackColor       =   &H00FFFFFF&
      Caption         =   " A)Oklahoma City Thunder "
      BeginProperty Font 
         Name            =   "Myriad Hebrew"
         Size            =   30
         Charset         =   0
   ...
   Begin VB.Label lblquestion 
      BackStyle       =   0  'Transparent
      Caption         =   "Which Team Drafted Stephen Curry?"
      BeginProperty Font 
         Name            =   "Myriad Hebrew"
         Size            =   21.75
         Charset         =   0
...
av = 1
MsgBox cmda.Caption + "=15%" + "," + cmdb.Caption + "=9%" + "," + cmdc.Caption + "=75%" + "," + cmdd.Caption + "=1%" + ",", (vbOKOnly), "Audience"
cmav.Visible = False
End Sub
...
aaf = 1
MsgBox "Your friend says that he is sure that the answer is" + cmdc.Caption, (vbOKOnly), "Ask a Friend"
...
choice = MsgBox("Are Your Sure That" + "" + cmdc.Caption + "Is The Correct Answer?", vbYesNo, "Correct")
...
cmdc.Visible = False
cmdd.Visible = False
MsgBox "Congratualtion, You Are Correct! You Won $1,000", (vbOKOnly), ("Correct")
Form6.Visible = False
Form7.Visible = True
moneywon = moneywon + 900
